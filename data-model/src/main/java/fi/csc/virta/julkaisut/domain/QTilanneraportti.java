...
public class QTilanneraportti extends com.querydsl.sql.RelationalPathBase<QTilanneraportti> {
	...
	public final NumberPath<Integer> julkaisunTila = createNumber("JulkaisunTila", Integer.class);
        ...
        public final NumberPath<Integer> avoinSaatavuusJulkaisumaksu = createString("avoinSaatavuusJulkaisumaksu");
        public final StringPath avoinSaatavuusJulkaisumaksuVuosi = createString("avoinSaatavuusJulkaisumaksuVuosi	");
	...
	addMetadata(julkaisunTila, ColumnMetadata.named("JulkaisunTila").withIndex(8).ofType(Types.INTEGER).withSize(10));
        ...
        addMetadata(avoinSaatavuusJulkaisumaksuVuosi, ColumnMetadata.named("avoinSaatavuusJulkaisumaksuVuosi").withIndex(16).ofType(Types.NVARCHAR).withSize(1));
        addMetadata(julkaisuKanavaOA, ColumnMetadata.named("julkaisuKanavaOA").withIndex(17).ofType(Types.INTEGER).withSize(10));
