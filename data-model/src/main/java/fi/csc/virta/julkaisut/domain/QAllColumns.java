...
public class QAllColumns extends com.querydsl.sql.RelationalPathBase<QAllColumns> {
    ...
    private static final long serialVersionUID = -822252903;

    public static final QAllColumns allColumns = new QAllColumns("all_columns");
    ...
    public QAllColumns(String variable) {
        super(QAllColumns.class, forVariable(variable), "sys", "all_columns");
        addMetadata();
    }

    public QAllColumns(String variable, String schema, String table) {
        super(QAllColumns.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QAllColumns(Path<? extends QAllColumns> path) {
        super(path.getType(), path.getMetadata(), "sys", "all_columns");
        addMetadata();
    }

    public QAllColumns(PathMetadata metadata) {
        super(QAllColumns.class, metadata, "sys", "all_columns");
        addMetadata();
    }
