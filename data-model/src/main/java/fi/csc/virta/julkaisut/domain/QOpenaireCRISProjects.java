...
public class QOpenaireCRISProjects extends com.querydsl.sql.RelationalPathBase<QOpenaireCRISProjects> {
    
    private static final long serialVersionUID = 189876543;

    public static final QOpenaireCRISProjects OpenaireCRISProjects = new QOpenaireCRISProjects("OpenaireCRISProjects");
    ...
    public final NumberPath<Long> OCProjID = createNumber("OCProjID", Long.class);

    public final com.querydsl.sql.PrimaryKey<QOpenaireCRISProjects> openaireCRISProjectsOCProjIDPK = createPrimaryKey(OCProjID);

    public QOpenaireCRISProjects(String variable) {
        super(QOpenaireCRISProjects.class, forVariable(variable), "dbo", "OpenaireCRISProjects");
        addMetadata();
    }

    public QOpenaireCRISProjects(String variable, String schema, String table) {
        super(QOpenaireCRISProjects.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QOpenaireCRISProjects(Path<? extends QOpenaireCRISProjects> path) {
        super(path.getType(), path.getMetadata(), "dbo", "OpenaireCRISProjects");
        addMetadata();
    }

    public QOpenaireCRISProjects(PathMetadata metadata) {
        super(QOpenaireCRISProjects.class, metadata, "dbo", "OpenaireCRISProjects");
        addMetadata();
    }
    
    public void addMetadata() {
        addMetadata(OCProjID, ColumnMetadata.named("OCProjID").withIndex(1).ofType(Types.BIGINT).withSize(19).notNull());
