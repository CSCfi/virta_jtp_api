...
/**
 * QDmExecTriggerStats is a Querydsl query type for QDmExecTriggerStats
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDmExecTriggerStats extends com.querydsl.sql.RelationalPathBase<QDmExecTriggerStats> {

    private static final long serialVersionUID = -1093412290;

    public static final QDmExecTriggerStats dmExecTriggerStats = new QDmExecTriggerStats("dm_exec_trigger_stats");
    ...
    public QDmExecTriggerStats(String variable) {
        super(QDmExecTriggerStats.class, forVariable(variable), "sys", "dm_exec_trigger_stats");
        addMetadata();
    }

    public QDmExecTriggerStats(String variable, String schema, String table) {
        super(QDmExecTriggerStats.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDmExecTriggerStats(Path<? extends QDmExecTriggerStats> path) {
        super(path.getType(), path.getMetadata(), "sys", "dm_exec_trigger_stats");
        addMetadata();
    }

    public QDmExecTriggerStats(PathMetadata metadata) {
        super(QDmExecTriggerStats.class, metadata, "sys", "dm_exec_trigger_stats");
        addMetadata();
    }
