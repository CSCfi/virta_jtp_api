...
/**
 * QAllParameters is a Querydsl query type for QAllParameters
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QAllParameters extends com.querydsl.sql.RelationalPathBase<QAllParameters> {

    private static final long serialVersionUID = 1025648046;

    public static final QAllParameters allParameters = new QAllParameters("all_parameters");
    ...
    public QAllParameters(String variable) {
        super(QAllParameters.class, forVariable(variable), "sys", "all_parameters");
        addMetadata();
    }

    public QAllParameters(String variable, String schema, String table) {
        super(QAllParameters.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QAllParameters(Path<? extends QAllParameters> path) {
        super(path.getType(), path.getMetadata(), "sys", "all_parameters");
        addMetadata();
    }

    public QAllParameters(PathMetadata metadata) {
        super(QAllParameters.class, metadata, "sys", "all_parameters");
        addMetadata();
    }
