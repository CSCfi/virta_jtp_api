...
/**
 * QDmBrokerConnections is a Querydsl query type for QDmBrokerConnections
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDmBrokerConnections extends com.querydsl.sql.RelationalPathBase<QDmBrokerConnections> {

    private static final long serialVersionUID = -248170698;

    public static final QDmBrokerConnections dmBrokerConnections = new QDmBrokerConnections("dm_broker_connections");
    ...
    public QDmBrokerConnections(String variable) {
        super(QDmBrokerConnections.class, forVariable(variable), "sys", "dm_broker_connections");
        addMetadata();
    }

    public QDmBrokerConnections(String variable, String schema, String table) {
        super(QDmBrokerConnections.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDmBrokerConnections(Path<? extends QDmBrokerConnections> path) {
        super(path.getType(), path.getMetadata(), "sys", "dm_broker_connections");
        addMetadata();
    }

    public QDmBrokerConnections(PathMetadata metadata) {
        super(QDmBrokerConnections.class, metadata, "sys", "dm_broker_connections");
        addMetadata();
    }
